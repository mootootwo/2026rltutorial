...
const player = new Actor(undefined, undefined, "@", "#ffffff", "Player", true);
const bigU = new Actor(undefined, undefined, "Ü", "#ff00ee", "Big Ü", true);
const lilU = new Actor(undefined, undefined, "ü", "#cc66ff", "Lil ü", true);
