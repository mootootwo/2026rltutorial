...
Since I don't have library functions to do most of that for me, it is a bit of a heavy ask to implement all that right in main().  But, in the spirit of following instructions, I do that [here](https://github.com/mootootwo/2026rltutorial/commit/6146a9d564093a48f0bd8f325151c62104345783). It is okay though, I know we will be moving it in the next step.
